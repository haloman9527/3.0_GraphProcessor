...
namespace CZToolKit.GraphProcessor.Editors
{
    public abstract class BaseNodeView : NodeView, IBindableView<BaseNode>
    {
        ...
        public readonly Dictionary<string, PortView> portViews = new Dictionary<string, PortView>();
        [NonSerialized]
        ...
        public void SetUp(BaseNode nodeViewModel, BaseGraphView graphView)
        {
            Model = nodeViewModel;
            Owner = graphView;
            ...
            {
                PortView portView = NewPortView(slot);
        ...
        #region Overrides
        public abstract PortView NewPortView(Slot slot);
