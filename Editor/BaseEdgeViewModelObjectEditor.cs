...
{
    [CustomObjectEditor(typeof(BaseEdge))]
    public class BaseEdgeViewModelObjectEditor : ObjectEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            ViewModel edgeViewModel = Target as ViewModel;
            foreach (var property in edgeViewModel.BindableProperties)
            {
